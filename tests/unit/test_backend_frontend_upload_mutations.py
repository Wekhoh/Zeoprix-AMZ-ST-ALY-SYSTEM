...
def _bootstrap(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv('AMZ_BACKEND_DATABASE_URL', f"sqlite:///{(tmp_path / 'backend-upload.db').as_posix()}")
...
def test_frontend_upload_files_endpoint_saves_rows_and_can_analyze(monkeypatch, tmp_path):
