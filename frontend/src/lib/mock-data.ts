...
export const workbenchStats = [
	...
	{
		label: "最近一次分析",
		value: "2026-04-11 · 12:34",
		detail: "latest snapshot 已形成。",
	},
	{
		label: "历史沉淀",
		value: "4 个分析快照",
		detail: "646 条人工审核、3 个执行批次。",
	},
	{
		label: "数据规模",
		value: "316 条词 · 6 个活动",
		detail: "当前已形成 98 条建议动作。",
	},
];
...
export const trendCards = [
	{
		label: "最近 7 天",
		value: "$5,803.51",
		detail: "订单 88 ｜ 销售额 $2,386.02 ｜ ACOS 243.23%",
	},
	{
		label: "最近 14 天",
		value: "$6,904.27",
		detail: "订单 101 ｜ 销售额 $2,998.40 ｜ ACOS 230.27%",
	},
	{
		label: "最近 30 天",
		value: "$11,884.22",
		detail: "订单 156 ｜ 销售额 $5,622.14 ｜ ACOS 211.39%",
	},
];
...
export const aiCopilotCards = [
	...
	},
	{
		title: "AI 执行说明",
		context:
			"当前产品：桌面验收产品 · 上下文：执行批次 NEG-20260411-120000-ABC123",
